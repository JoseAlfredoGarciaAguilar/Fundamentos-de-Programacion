...
//PROGRAMA QUE IMPRIME EL NÚMERO DE DÍAS DE CADA MES, AL INGRESAR EL AÑO

public class Problema6 {

	public static void main(String[] args) {
		Scanner entrada = new Scanner(System.in);
		System.out.println("-Programa que determina el número de días de cada mes, al ingresar el año-");
